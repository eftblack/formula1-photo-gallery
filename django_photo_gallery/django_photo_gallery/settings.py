...
ALLOWED_HOSTS = ['0.0.0.0','127.0.0.1','localhost', 'https://formula1-photo-gallery.herokuapp.com/']
INTERNAL_IPS = ('0.0.0.0','127.0.0.1','localhost', 'https://formula1-photo-gallery.herokuapp.com/')
